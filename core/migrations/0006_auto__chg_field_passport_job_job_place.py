...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Passport.job_job_place'
        db.alter_column(u'core_passport', 'job_job_place', self.gf('django.db.models.fields.CharField')(max_length=10000))

    def backwards(self, orm):

        # Changing field 'Passport.job_job_place'
        db.alter_column(u'core_passport', 'job_job_place', self.gf('django.db.models.fields.TextField')())
