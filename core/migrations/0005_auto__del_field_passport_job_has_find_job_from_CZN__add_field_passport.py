...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Passport.job_has_find_job_from_CZN'
        db.delete_column(u'core_passport', 'job_has_find_job_from_CZN')

        # Adding field 'Passport.job_how_hired'
        db.add_column(u'core_passport', 'job_how_hired',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Passport.job_has_find_job_from_CZN'
        db.add_column(u'core_passport', 'job_has_find_job_from_CZN',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'Passport.job_how_hired'
        db.delete_column(u'core_passport', 'job_how_hired')
