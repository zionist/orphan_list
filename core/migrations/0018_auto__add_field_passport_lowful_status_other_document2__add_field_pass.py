...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Passport.lowful_status_other_document2'
        db.add_column(u'core_passport', 'lowful_status_other_document2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True),
                      keep_default=False)

        # Adding field 'Passport.lowful_status_date_of_death2'
        db.add_column(u'core_passport', 'lowful_status_date_of_death2',
                      self.gf('django.db.models.fields.DateField')(max_length=2048, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Passport.lowful_status_other_document2'
        db.delete_column(u'core_passport', 'lowful_status_other_document2')

        # Deleting field 'Passport.lowful_status_date_of_death2'
        db.delete_column(u'core_passport', 'lowful_status_date_of_death2')
    ...
    models = {
        'core.passport': {
            ...
            'lowful_status_date_of_death': ('django.db.models.fields.DateField', [], {'max_length': '2048', 'null': 'True', 'blank': 'True'}),
            'lowful_status_date_of_death2': ('django.db.models.fields.DateField', [], {'max_length': '2048', 'null': 'True', 'blank': 'True'}),
            ...
            'lowful_status_other_document': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'blank': 'True'}),
            'lowful_status_other_document2': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'blank': 'True'}),
