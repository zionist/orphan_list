...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Passport.form_of_care_spokesman_data'
        db.alter_column(u'core_passport', 'form_of_care_spokesman_data', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Passport.registration_no_reqistration_reason'
        db.alter_column(u'core_passport', 'registration_no_reqistration_reason', self.gf('django.db.models.fields.CharField')(max_length=10000))

    def backwards(self, orm):

        # Changing field 'Passport.form_of_care_spokesman_data'
        db.alter_column(u'core_passport', 'form_of_care_spokesman_data', self.gf('django.db.models.fields.CharField')(max_length=10000))

        # Changing field 'Passport.registration_no_reqistration_reason'
        db.alter_column(u'core_passport', 'registration_no_reqistration_reason', self.gf('django.db.models.fields.TextField')())
