...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Passport.job_other'
        db.alter_column(u'core_passport', 'job_other', self.gf('django.db.models.fields.CharField')(max_length=10000))

    def backwards(self, orm):

        # Changing field 'Passport.job_other'
        db.alter_column(u'core_passport', 'job_other', self.gf('django.db.models.fields.TextField')())
