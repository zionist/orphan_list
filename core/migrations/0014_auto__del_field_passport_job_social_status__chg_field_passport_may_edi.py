...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Passport.may_edit'
        db.alter_column(u'core_passport', 'may_edit', self.gf('django.db.models.fields.BooleanField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Passport.may_edit'
        db.alter_column(u'core_passport', 'may_edit', self.gf('django.db.models.fields.BooleanField')(max_length=1024))
