...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Passport.order_date_negative'
        db.add_column(u'core_passport', 'order_date_negative',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Passport.order_date_negative'
        db.delete_column(u'core_passport', 'order_date_negative')
