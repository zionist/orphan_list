...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Passport.order_number_of_queue'
        db.add_column(u'core_passport', 'order_number_of_queue',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Passport.order_number_of_queue'
        db.delete_column(u'core_passport', 'order_number_of_queue')
    ...
    models = {
        'core.passport': {
            ...
            'order_number_of_queue': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
