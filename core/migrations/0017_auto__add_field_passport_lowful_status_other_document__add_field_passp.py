...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Passport.lowful_status_other_document'
        db.add_column(u'core_passport', 'lowful_status_other_document',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True),
                      keep_default=False)

        # Adding field 'Passport.lowful_status_date_of_death'
        db.add_column(u'core_passport', 'lowful_status_date_of_death',
                      self.gf('django.db.models.fields.DateField')(max_length=2048, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Passport.lowful_status_other_document'
        db.delete_column(u'core_passport', 'lowful_status_other_document')

        # Deleting field 'Passport.lowful_status_date_of_death'
        db.delete_column(u'core_passport', 'lowful_status_date_of_death')
