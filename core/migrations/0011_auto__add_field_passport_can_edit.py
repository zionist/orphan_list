...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_passport', 'can_edit',
                      self.gf('django.db.models.fields.CharField')(default='\xd0\x9d\xd0\xb5\xd1\x82', max_length=1024, blank=True),
                      keep_default=False)
    ...
    models = {
        'core.passport': {
            ...
            'can_edit': ('django.db.models.fields.CharField', [], {'default': "'\\xd0\\x9d\\xd0\\xb5\\xd1\\x82'", 'max_length': '1024', 'blank': 'True'}),
