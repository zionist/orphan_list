...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Passport.lowful_document_name'
        db.add_column(u'core_passport', 'lowful_document_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Passport.lowful_document_name'
        db.delete_column(u'core_passport', 'lowful_document_name')
