...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_passport', (
            ...
            ('date_of_list', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ...
            ('has_real_estate', self.gf('django.db.models.fields.CharField')(default=False, max_length=255)),
            ...
            ('date_of_service_expired', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
    ...
    models = {
        'core.passport': {
            ...
            'date_of_list': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'date_of_service_expired': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'has_real_estate': ('django.db.models.fields.CharField', [], {'default': 'False', 'max_length': '255'}),
