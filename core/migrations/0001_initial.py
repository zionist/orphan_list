...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_passport', (
            ...
            ('registration_no_reqistration_reason', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('registration_address_region', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('registration_address_mo', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('registration_address_address', self.gf('django.db.models.fields.TextField')(blank=True)),
            ...
            ('job_has_find_job_from_CZN', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('job_job_place', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('job_eduction_type', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('job_education_house', self.gf('django.db.models.fields.TextField')(max_length=255, blank=True)),
            ('job_other', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('job_started', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('jov_started', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('lodgin_accordance', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
    ...
    models = {
        'core.passport': {
            ...
            'job_education_house': ('django.db.models.fields.TextField', [], {'max_length': '255', 'blank': 'True'}),
            'job_eduction_type': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'job_has_find_job_from_CZN': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'job_job_place': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'job_other': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'registration_address_address': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'registration_address_mo': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'registration_address_region': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'registration_no_reqistration_reason': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
