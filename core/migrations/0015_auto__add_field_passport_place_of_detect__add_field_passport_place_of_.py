...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Passport.place_of_detect'
        db.add_column(u'core_passport', 'place_of_detect',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True),
                      keep_default=False)

        # Adding field 'Passport.place_of_detect_mo'
        db.add_column(u'core_passport', 'place_of_detect_mo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True),
                      keep_default=False)

        # Adding field 'Passport.place_of_detect_document_name'
        db.add_column(u'core_passport', 'place_of_detect_document_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True),
                      keep_default=False)

        # Adding field 'Passport.place_of_detect_document_date'
        db.add_column(u'core_passport', 'place_of_detect_document_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Passport.place_of_detect_document_number'
        db.add_column(u'core_passport', 'place_of_detect_document_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Passport.place_of_detect'
        db.delete_column(u'core_passport', 'place_of_detect')

        # Deleting field 'Passport.place_of_detect_mo'
        db.delete_column(u'core_passport', 'place_of_detect_mo')

        # Deleting field 'Passport.place_of_detect_document_name'
        db.delete_column(u'core_passport', 'place_of_detect_document_name')

        # Deleting field 'Passport.place_of_detect_document_date'
        db.delete_column(u'core_passport', 'place_of_detect_document_date')

        # Deleting field 'Passport.place_of_detect_document_number'
        db.delete_column(u'core_passport', 'place_of_detect_document_number')
    ...
    models = {
        'core.passport': {
            ...
            'may_edit': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'place_of_detect': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'blank': 'True'}),
            'place_of_detect_document_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'place_of_detect_document_name': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'blank': 'True'}),
            'place_of_detect_document_number': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'place_of_detect_mo': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'blank': 'True'}),
