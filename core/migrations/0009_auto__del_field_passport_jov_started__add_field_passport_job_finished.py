...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Passport.jov_started'
        db.delete_column(u'core_passport', 'jov_started')

        # Adding field 'Passport.job_finished'
        db.add_column(u'core_passport', 'job_finished',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Passport.jov_started'
        db.add_column(u'core_passport', 'jov_started',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Passport.job_finished'
        db.delete_column(u'core_passport', 'job_finished')
