...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Passport.can_edit'
        db.delete_column(u'core_passport', 'can_edit')

        # Adding field 'Passport.may_edit'
        db.add_column(u'core_passport', 'may_edit',
                      self.gf('django.db.models.fields.BooleanField')(default=True, max_length=1024),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Passport.can_edit'
        db.add_column(u'core_passport', 'can_edit',
                      self.gf('django.db.models.fields.BooleanField')(default=True, max_length=1024),
                      keep_default=False)
    ...
    models = {
        'core.passport': {
            ...
            'may_edit': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'max_length': '1024'}),
