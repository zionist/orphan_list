...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Passport.registration_address_mo'
        db.alter_column(u'core_passport', 'registration_address_mo', self.gf('django.db.models.fields.CharField')(max_length=409))

        # Changing field 'Passport.registration_address_region'
        db.alter_column(u'core_passport', 'registration_address_region', self.gf('django.db.models.fields.CharField')(max_length=2048))

        # Changing field 'Passport.registration_address_address'
        db.alter_column(u'core_passport', 'registration_address_address', self.gf('django.db.models.fields.CharField')(max_length=10000))

    def backwards(self, orm):

        # Changing field 'Passport.registration_address_mo'
        db.alter_column(u'core_passport', 'registration_address_mo', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Passport.registration_address_region'
        db.alter_column(u'core_passport', 'registration_address_region', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Passport.registration_address_address'
        db.alter_column(u'core_passport', 'registration_address_address', self.gf('django.db.models.fields.TextField')())
