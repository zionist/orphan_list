...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Passport.form_of_care'
        db.delete_column(u'core_passport', 'form_of_care')
    ...
    def backwards(self, orm):
        # Adding field 'Passport.form_of_care'
        db.add_column(u'core_passport', 'form_of_care',
