...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Passport.person_before_2013_document_name'
        db.add_column(u'core_passport', 'person_before_2013_document_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True),
                      keep_default=False)

        # Adding field 'Passport.person_before_2013_document_date'
        db.add_column(u'core_passport', 'person_before_2013_document_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Passport.person_before_2013_document_number'
        db.add_column(u'core_passport', 'person_before_2013_document_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True),
                      keep_default=False)

        # Adding field 'Passport.lowful_document_name2'
        db.add_column(u'core_passport', 'lowful_document_name2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Passport.lowful_status_date2'
        db.add_column(u'core_passport', 'lowful_status_date2',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Passport.lowful_status_number2'
        db.add_column(u'core_passport', 'lowful_status_number2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Passport.job_social_status'
        db.add_column(u'core_passport', 'job_social_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Passport.person_before_2013_document_name'
        db.delete_column(u'core_passport', 'person_before_2013_document_name')

        # Deleting field 'Passport.person_before_2013_document_date'
        db.delete_column(u'core_passport', 'person_before_2013_document_date')

        # Deleting field 'Passport.person_before_2013_document_number'
        db.delete_column(u'core_passport', 'person_before_2013_document_number')

        # Deleting field 'Passport.lowful_document_name2'
        db.delete_column(u'core_passport', 'lowful_document_name2')

        # Deleting field 'Passport.lowful_status_date2'
        db.delete_column(u'core_passport', 'lowful_status_date2')

        # Deleting field 'Passport.lowful_status_number2'
        db.delete_column(u'core_passport', 'lowful_status_number2')

        # Deleting field 'Passport.job_social_status'
        db.delete_column(u'core_passport', 'job_social_status')
