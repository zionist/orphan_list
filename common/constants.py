...
LOWFUL_STATUSES = (
    ...
    (u"Ребенок оставшийся без попечения родителей", u"Ребенок оставшийся без попечения родителей"),
)
...
LOWFUL_STATUS_DOCUMENS_CHOICES = (
    (u"Акты об оставлении ребенка", u"Акты об оставлении ребенка"),
    (u"Решение суда о лишении родителя родительских прав", u"Решение суда о лишении родителя родительских прав"),
    (u"Решение суда об ограничении родителя в родительских правах", u"Решение суда об ограничении родителя в родительских правах"),
    (u"Решение суда о признании родителя безвозмездно отсутствующим", u"Решение суда о признании родителя безвозмездно отсутствующим"),
    (u"Решение суда о признании родителя недееспособным", u"Решение суда о признании родителя недееспособным"),
    (u"Справка о рождении", u"Справка о рождении"),
    (u"Свидетельство о смерти", u"Свидетельство о смерти"),
    (u"Иной документ", u"Иной документ"),
)
